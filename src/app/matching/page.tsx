...
import { Search, Filter, MapPin, Droplet, Phone, Navigation } from "lucide-react";
                ...
                <div key={donor.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex flex-col gap-4 pt-4 border-t border-gray-100">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <a
                        href={`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(donor.address || donor.location)}`}
                        target="_blank"
                      ...
                      <button className="w-full px-3 py-2.5 bg-red-600 text-white rounded-xl text-sm font-semibold hover:bg-red-700 transition-colors flex items-center justify-center gap-2 shadow-sm shadow-red-200">
                        <Phone className="h-4 w-4 shrink-0" /> Contact
                      </button>
                    </div>
                  </div>
                </div>
